...
import com.fsz570.exam_demo.adapter.TopicOnePagerAdapter;
...
public class TopicOneActivity extends FragmentActivity {
    ...
    private TopicOnePagerAdapter mPagerAdapter;

    private static final int[] correctAnswers = {1,1,2,2,1,3,3,2,1,2};
    ...
    private void initUi(){
        ...
        mPagerAdapter = new TopicOnePagerAdapter(getSupportFragmentManager());
        ...
        mPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener(){
            ...
            @Override public void onPageSelected(    int position){
                if(position<correctAnswers.length) {
                    ...
                    ((TopicOneResultFragment)mPagerAdapter.getItem(position)).setScore();
    ...
    private void setResultBackground(){
        ...
        if(sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
            background.setBackgroundDrawable(getResources().getDrawable(R.drawable.result_one));
        } else {
            background.setBackground(getResources().getDrawable(R.drawable.result_one));
        }
    }
