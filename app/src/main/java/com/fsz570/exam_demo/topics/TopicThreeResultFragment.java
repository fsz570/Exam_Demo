...
import com.fsz570.exam_demo.TopicThreeActivity;

public class TopicThreeResultFragment extends Fragment {

    private RatingBar ratingBar1, ratingBar2;
    private TopicThreeActivity parentActivity;
    private ViewGroup rootView;
    private Button btnFinish;

    public TopicThreeResultFragment() {
    ...
    private void initUi(){
        ratingBar1 = (RatingBar) getActivity().findViewById(R.id.rating_bar1);
        ratingBar2 = (RatingBar) getActivity().findViewById(R.id.rating_bar2);
    ...
    public void setScore(){
        parentActivity = (TopicThreeActivity)getActivity();
