...
import com.fsz570.exam_demo.TopicTwoActivity;

public class TopicTwoResultFragment extends Fragment {

    private RatingBar ratingBar1, ratingBar2;
    private TopicTwoActivity parentActivity;
    private ViewGroup rootView;
    private Button btnFinish;

    public TopicTwoResultFragment() {
    ...
    public void setScore(){
        parentActivity = (TopicTwoActivity)getActivity();
